...
function Header()
{
    ...
    $this->Image('image/icon.PNG',5,5,35,35);
	 //Logo
    $this->Image('image/icon.PNG',170,5,35,35);
    //Arial bold 15
...
function Footer()
{
  ...
  $this->SetFont('Arial','I',7);
	...
	$this->SetFont('Arial','I',7);
	$this->Cell(-30,10, 'online voting System',0,0,'C');
}
}
...
$pdf->SetY($y);
$pdf->SetX($x);
$pdf->Cell(200, 5, 'LIST OF ELECTION VOTER REGISTERD', 0, 0, 'C');
$y = $y + 7;
...
$st = "SELECT * FROM instution WHERE typez='voter'";
