...
$select = "SELECT * FROM instution WHERE typez='voter' and id='$pid'";
...
if(isset($_POST['regster'])){
    ...
    if(empty($error)){
        $insert = "UPDATE instution SET iname='$iname',email='$email',dob='$dob',image='$img' WHERE id='$vid'";
        ...
        <div class="card-deck-wrapper">
            <div class="card-deck">
                <div class="card col-md-6">
                    ...
                    <H4 class="text-center">UPDATE VOTER<H4>
                    </div>
                    <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
...
?>
                        ...
                        <div>voter Full Name: </div>
                    <div><input type="text" name="iname" id="iname" value="<?php echo $iname; ?>" class="form-control"><span id="isms" class="error"></span></div>
                    <div>Date of Birth: </div>
                    <div><input type="date" name="dob" id="dob" min="2003-01-02"  value="<?php echo $aname; ?>" class="form-control" ><span id="dsms" class="error"></span></div>
