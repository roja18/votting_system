...
if(isset($_POST['activet'])){
    ...
    if($otp!=$token){
        ...
        if($query){
            $smgz = base64_encode("Your Success to activet your account you can login now");
...
?>
                    ...
                    <div><br></div>
                        <input type="submit" name="activet" value="Activate" class="btn bg-success" value="Regster" onclick="return checkMy()">
