...
$x = $x + 45;
$pdf->SetX($x);
$pdf->Cell(60, 5, 'TOTAL VOTE ', 1, 0, 'C');
...
$st = "SELECT COUNT(result.kula) AS idadi,(COUNT(*)/$kura)*100 as aver,instution.image, result.candidate, result.kula, result.cand, result.eplace, result.part, result.position FROM result,instution WHERE result.candidate=instution.email GROUP BY result.cand ";
