...
$pdf->SetY($y);
$pdf->SetX($x);
$pdf->Cell(35, 5, 'PARTIES NAME', 1, 0, 'C');

$x = $x + 35;
$pdf->SetX($x);
$pdf->Cell(60, 5, 'STROGAN ', 1, 0, 'C');

$x = $x + 60;
$pdf->SetX($x);
$pdf->Cell(40, 5, 'PARTIES FRAG ', 1, 0, 'C');

$x = $x + 40;
$pdf->SetX($x);
$pdf->Cell(45, 5, 'REGSTED DATE ', 1, 0, 'C');
...
// //     $pdf->Cell(35, 5,  1, 0, 'L');
    ...
    $pdf->SetY($y);
    $pdf->SetX($x);
    $pdf->Cell(60, 5, $pstg, 1, 0, 'L');

    $x = $x + 60;
    $pdf->SetY($y);
    $pdf->SetX($x);
    $pdf->Cell(40, 5, $image, 1, 0, 'L');


    $x = $x + 40;
    $pdf->SetY($y);
    $pdf->SetX($x);
    $pdf->Cell(45, 5, $adate, 1, 0, 'L');
